...
class sxreader_com(unittest.TestCase):
    ...
    def test_1(self):
        ...
        for user in data:
            ...
            #driver.find_element_by_xpath(".//*[@id='app-body']/div[2]/div/div/div/div/div[4]/ul/li[2]/div/div[2]/a[2]/span").click()
            time.sleep(1)
            #清空作业标题
            driver.find_element_by_xpath(".//*[@id='app-body']/div[2]/div/div/div/div/div[3]/div[1]/input").clear()
            #输入作业标题内容
            time.sleep(1)
            driver.find_element_by_xpath(".//*[@id='app-body']/div[2]/div/div/div/div/div[3]/div[1]/input").send_keys("作业标题")
            #清空作业内容
            time.sleep(1)
            driver.find_element_by_xpath(".//*[@id='app-body']/div[2]/div/div/div/div/div[3]/div[2]/textarea").clear()
            #输入作业内容
            driver.find_element_by_xpath(".//*[@id='app-body']/div[2]/div/div/div/div/div[3]/div[2]/textarea").send_keys("作业内容")
            
            #点击提交按钮
            driver.find_element_by_xpath(".//*[@id='app-body']/div[2]/div/div/div/div/div[5]/button").click()
            time.sleep(1)

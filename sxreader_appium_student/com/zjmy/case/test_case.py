...
from bookself_business import BookSelfBusiness
...
class CaseTest(ParameTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.book_self = BookSelfBusiness(parames)
    ...
    def test_fail(self):
        ...
        self.login_bus.login_password_error()
    ...
    def test_suc(self):
        ...
        self.book_self.begin_book_self()

        # self.assertEqual('1','2','数据错误')

    def test_book(self):
        self.book_self.begin_book_self()
        self.book_self.click_cloud_suc()
...
def get_suite(i):
    ...
    print('test_book中的 i ********************：', i)
    suite.addTest(CaseTest('test_book', parame=i))
